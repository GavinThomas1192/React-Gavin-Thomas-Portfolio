...
const projects = [
  {
    title: "Software Engineer - Logistics Intelligence - Seattle, WA",
    description:
      "Full Stack Software Engineer",
    slug: "li",
    stack: "Using: React-Native, React, Node-CQRS, Docker, AWS, and GCP",
    link: "https://www.logisticsintelligence.com/",
    github: "https://github.com/AttackPattern",
    img: require("../../img/facetDev/facetDev2.png"),
    author: "Gavin Thomas",
    date: "2018-2020",
    technicalDescription:
      `Built from the ground up my team built a full stack solution to the logistics problems facing the oil and gas industry. We provided a logistics solution for wasted time and resources in all aspects of the operation. Our team built a web portal, mobile apps, and analytics portal all disrupting the market tremendously.`,
    featured: true,
    secondaryPictures: [
      require("../../img/li/li1.png"),
    ]
  },
  {
    title: "Mobile App - Archbright - Seattle, WA",
    description:
      "Full Stack Mobile Engineer",
    slug: "archbright",
    stack: "Using: React-Native, Node, Docker, and Azure",
    link: "https://www.archbright.com/page/archbright-mobile",
    github: "https://github.com/AttackPattern",
    img: require("../../img/archbright/archbrightTest.png"),
    author: "Gavin Thomas",
    date: "2018 - 2019",
    technicalDescription:
    `Designed, Engineered, Built, Tested, and Deployed Archbright Mobile was Archbright's first mobile application aiming to make their customers lives easier. My team built both a new mobile app (android and iOS), and an accompanying server built with node. Solving Archbright's unique problems, consisting of needing a new mobile app yet integrating with older existing api's that they currently used via their CRM. Mobile apps can be found from the linked website at the bottom.`,
    featured: true,
    secondaryPictures: [
      require("../../img/archbright/archbright2.png"),
      require("../../img/archbright/archbrightTest.png"),
    ]
  },
  {
